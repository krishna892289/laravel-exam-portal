...
Route::middleware(checkloggedin::class)->group(function(){
    ...
    Route::get('/student/results', [HomeController::class, 'results'])->name('results');
    ...
    Route::middleware(RoleCheckMiddleware::class)->group(function(){
        ...
        Route::post('/teacher/edit_assign_test', [TeacherController::class, 'edit_assign_test'])->name('edit_assign_test');
        ...
        Route::post('/edit_submit_question', [TeacherController:: class, 'edit_submit_question'])->name('edit_submit_question');
        ...
        Route::post('/teacher/view_questions_ajax', [TeacherController::class, 'view_questions_ajax'])->name('view_questions_ajax');
